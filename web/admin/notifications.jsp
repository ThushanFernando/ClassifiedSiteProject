					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="page-header">
								<h1>Notifications <small>all</small></h1>
							</div>
							...
							<div class="panel panel-default">
								...
								<div class="panel-body panel-scroll" style="height:300px">
									<table class="table table-striped table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center hidden-xs">Not-ID</th>
												<th>Content</th>
												<th>Time</th>
												<th></th>
											</tr>
										...
										<tbody>
												...
												<td class="center hidden-xs">1122110</td>
                                                                                                <td><a href="#">Peter Clark</a> posted an add "<a href="#">Samsung galaxy note n7000 for sale"</a></td>
														...
														<ul role="menu" class="dropdown-menu pull-right">
															<li role="presentation">
																<a role="menuitem" tabindex="-1" href="#">
																	<i class="fa clip-remove"></i> Delete
																</a>
															</li>
