...
$(document).on('click', 'clickedReportBlockAd', function () {
    if (document.getElementById('itemR' + this.id).value === "") {
        ...
        document.getElementById("contentidBA-header").value = 'Hello,\n\nYour ad "' + document.getElementById('itemT' + this.id).value  + ' ", posted on Superb.lk, does not follow our rules. You must make some changes to the ad before we can re-publish it.\n\nThe reason why we did disable your ad:\n\n';
