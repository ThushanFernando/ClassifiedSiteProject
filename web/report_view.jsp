                                ...
                                <ul id="myTab" class="nav nav-tabs tab-bricky">
                                    <li class="active">
                                        <a href="#panel_tab_Ads" data-toggle="tab">
                                            <span class="hidden-xs">Ads</span><span class="visible-xs">Ads</span> <span class="badge badge"><%=reportCount%></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#panel_tab_Message" data-toggle="tab">
                                            <span class="hidden-xs">Messages</span><span class="visible-xs">Messages</span> <span class="badge badge"><%=message_report_count%></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#panel_tab_Inquiry" data-toggle="tab">
                                            <span class="hidden-xs">Inquiries</span><span class="visible-xs">Inquiries</span> <span class="badge badge"><%=Inquiry_report_count%></span>
                                        </a>
                                    </li>
                                </ul>
